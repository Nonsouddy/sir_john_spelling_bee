    ...
    return (
        <>
            ...
            <div className=' min-h-screen  w-full'>
                <div className='container  max-w-7xl mx-auto px-4 py-8 md:px-8  md:ml-0 sm:ml-1' >
                    <div className='flex lg:flex-row items-center gap-20'>
                        ...
                        <div className='hidden mr-[-6rem] lg:mt-[-15.5rem] lg:block lg:w-full lg:h-full lg:left-[739px] lg:top-[133px] md:w-full md:mt-[-15.5rem]'>


                            <Image src={Img1} alt='School Image' className=" w-full h-[739px] md:w-full h-full"/>
