                ...
                <div className='about-section'>
                    <div>
                        ...
                        <div className='about-col1'>
                            <h1>Sir John’s <span>Spelling</span> Bee</h1>
                            <p>Sir John’s Spelling Bee is a competition for children aged 5–17, aimed at fostering effective communication skills, enriching vocabulary, improving pronunciation, and cultivating poise and confidence. It promotes literacy by emphasizing the power of words as tools for dreaming, building, and exploring.</p>
                        </div>
                        <div className='about-moon'><Image src={moon} alt='image' /></div>
                    </div>
                    <div className='about-col2'>
                        <Image src={Img1} alt='School Image' />
                    </div>
                </div>
                <div className='line'>
