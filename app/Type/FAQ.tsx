...
const faqData: FAQItem[] = [
  ...
  { question: "Who can participate in Sir John’s Spelling Bee?",
     answer:"Any pupil or student between the ages of 5 and 17 can participate. Participants are grouped into four categories: Early Spellers (Primary 1-2),Upper Primary (Primary 3-5),Junior Secondary (JSS 1-3),Senior Secondary (SS 1-3)",
   },
  {
   question: "Is The SJS Bee For Only Selected Schools Or Individuals?",
    answer: "No, the SJS Bee is for Primary and Secondary School Learners in Nigeria - ages 5 to 17 in both public and private schools."
  },
  {
  ...
  
  {
    ...
    answer: "Sir John's Spelling Bee provide study list for spellers in all categories. The word list is to guide and prepare them for the preliminary stages of the competition as additional word-lists will be introduced during the advanced level of the competition."
  },
  
  {
    question: "What Is The Registration Cost?",
    answer: "Registration for the competition is #10,000 only per participant. Registration fee is to be paid at any branch of Zenith Bank PLC, Account number 1229156554 (Sir John's Spelling Bee). Payment can also be made via Mobile/Web/ATM transfer.After payment, visit the registration portal to fill in the details of the speller(s). A confirmation slip will be presented after a successful registration. Spellers are expected to submit their confirmation slips during accreditation on the competition day."
  },
  
  {
    question: "How Many Students Can Register From My School?",
    answer: "There is no limit to the number of spellers a school can register. Every student who meets the eligibility criteria is welcome to participate in the Sir John's Spelling Bee.Schools are encouraged to give all interested learners the opportunity to compete."
  },
  {
    question: "Are There Any Discounts?",
    answer: "Yes, schools registering 10 spellers and more spellers will get discounts. For every 10 spellers registered, the school get #10,000 discount.That is, XYZ school would only pay #90,000 for 10 spellers (instead of #100,000) or #180,000 for 20 spellers (instead of #200,000). Simply make a bulk payment for all the spellers, and use the same payment reference for all registration entries."
},
  {
    question: "What Is The Official Dictionary?",
    answer: "The official dictionary for the SIr John's Spelling Bee is the Oxford Dictionary Of English. This dictionary serves as the exclusive source for words and adjudication criteria used in the competition. This dictionary because of its size can only be downloaded and used online from the Google Playstore."
  },
  {
    question: " When Is The Competition?",
    answer: " The competition CALENDAR will display the dates, venues, and time for each state across Nigeria.If your state is not listed under 'Upcoming' or 'Concluded', don't worry! You'll be communicated once details are confirmed. In the meantime, we implore you to register, download the word-list, and prepare your learners ahead of time. "
  },

  {
    question: "How Can My School Host The Competition?",
    answer: "  Schools that are interested in hosting the Sir John's Spelling Bee are welcome to submit their request. Hosting the competition offers unique benefits for schools.For more information on how to become a host and benefits involved, please contact us to make your request official."
  },
  {
  ...
  },
  {
    ...
    answer: " If you have additional questions or need further clarification that isn't covered above, please follow these  steps:1. WhatsApp: You can send your inquiry via WhatsApp to 08144118744.2. Text Message (SMS): Send your question along with your state to 08126492629. You will receive a prompt response.We are here to assist and ensure you have all the information you need!"
  },
        ...
        <div className="hidden lg:flex flex-col justify-center p-12 space-y-6 transform transition-all duration-300 hover:scale-[1.02]">
          ...
          <div className=' flex gap-6'>
             ...
             <div className='text-2xl flex gap-6 pt-6 '>
              ...
              <div className='text-center font-bold justify-center pt-1 w-[30px] h-[40px] bg-orange50 text-orange800 ml-2 '>_</div>
               <span className=' text-center font-bold justify-center pt-1 w-[30px] h-[40px] bg-orange50 text-orange800 ml-2 mt-4'>I</span>
               <div className='text-center font-bold justify-center pt-1 w-[30px] h-[40px] bg-orange50 text-orange800 ml-2 '>T</div>
        ...
        <div className="p-6 lg:p-12 space-y-10 font-inter">
          ...
          {faqData.slice(0, visibleItems).map((faq, index) => (
            ...
            >
              ...
              >
                <h2 className="text-xl font-semibold text-defaultColor transition-colors">
                  {faq.question}
                </h2>
                {expandedIndex === index ? (
                  <ArrowDown className="text-normalBlue group-hover:text-accentOrange" />
                ) : (
                  <ArrowRight className="text-normalBlue group-hover:text-accentOrange" />
                )}
              </div>
