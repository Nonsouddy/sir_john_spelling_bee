  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url("/Images/globalBackground.png")`, 
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 overflow-hidden">
        ...
        <div
          className="hidden lg:flex flex-col justify-center p-12 space-y-6 transform transition-all duration-300 hover:scale-[1.02] bg-cover bg-center"
            ...
            >
              ...
              >
                ...
                {expandedIndex === index ? (
                  ...
                  <ArrowRight className="w-6 h-6 text-normalBlue group-hover:text-accentOrange" />
                )}
              </div>
