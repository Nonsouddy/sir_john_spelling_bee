        ...
        <section className="py-16 overflow-hidden relative bg-white">
            <div className="container mx-auto max-w-full font-['Comic_Sans_MS']">
                ...
                /> */}
                            ...
                            {/* Step 2 */}
                            <div className="flex flex-col md:flex-row items-center justify-end mb-16 mt-24 relative">
                ...
                /> */}
                            ...
                            {/* Step 4 */}
                            <div className="flex flex-col md:flex-row items-center justify-end  mb-24 relative mt-24">
